...
Widget TitlePage(BuildContext context, String text, bool boton) {
  return Container(
...
Widget HotelRating(BuildContext context, int rating) {
  return Container(
    ...
    decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(5), color: Color(0x20FFC700)),
    child: Row(
...
Widget HotelInformationFrame(BuildContext context) {
  return Container(
      ...
      child: Column(
        children: [
          HotelInformation(context, "Удобства", 'assets/icon/emoji-happy.svg'),
          const Padding(
            padding: EdgeInsets.only(left: 53-15),
            child: Divider(color: Color(0X15828796),),
          ),
          HotelInformation(context, "Что включено", 'assets/icon/tick-square.svg'),
          const Padding(
            padding: EdgeInsets.only(left: 53-15),
            child: Divider(color: Color(0X15828796),),
          ),
          HotelInformation(context, "Что не включено",  'assets/icon/close-square.svg'),
        ],
      ));
}
  ...
  return Row(
    children: [
      ...
      Column(
        ...
        children: [
          TextFormat(
              context, text, 16, 19.2, 'SF Pro Display', Color(0xFF2C3035)),
          const SizedBox(height: 2,),
          TextFormat(
              context, 'Самое необходимое', 14, 16.8, 'SF Pro Display', Color(0xFF828796)),
        ],
      ),
